function ssm_emfit_fast_sad(sj, option)
    rng(1)
    ...
    for ms = 1:option.maxms
        ...
        for j = 0:3
            ...
            while (i==1 || LLR > tol * abs(MLL(1)) || LLR < 0) && i < MaxIter  
                ...
                if j == 0
                    netest = ssm_estimation_sad(option, Ez, Ezz, Ezz_1, mood, inp, netest.S, []);
                else
                    netest = ssm_estimation_sad(option, Ez, Ezz, Ezz_1, mood, inp, netest.S, netest.G);
                end
